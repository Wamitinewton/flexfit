...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  // create a method for retrieving current location
  // use geolocator in this case
  ...
  // mrthod for retriving the current address of the user
  ...
  // method for calculating the distance between two points on the map.

  Future<bool> _calculateDistance() async {
    try {
      // retreiving placemarks from addresses
        ...
        body: Stack(
          children: <Widget>[
            ...
            GoogleMap(
              ...
              initialCameraPosition: _intialLocation,
